...
public class Parrticular_DoctorData29May {

    private static final Logger logger = Logger.getLogger(Particular_DoctorData.class);
...
//                        System.out.println("Doctor Additional Photos " + (i + 1) + " URL: NA");
                ...
                DoctorData doctorData = new DoctorData(doctorName, doctorProfileImage, doctorSpecialization, doctorRating, doctorEducation, additionalPhotosUrls);
...
class DoctorData {
    ...
    public DoctorData(String doctorName, String profileImage, String specialization, String rating, String education, String[] additionalPhotos) {
